            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                <input class="form-control" placeholder="" type="number" name="tahunTerbit" value="{{ $buku->tahunTerbit}}">
                                            </div>
                                        </div>
                        ...
                        <a href="{{route('buku.index')}}" class="btn btn-secondary pd-x-30 mg-t-5"><i class='fa fa-chevron-left'></i> Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
